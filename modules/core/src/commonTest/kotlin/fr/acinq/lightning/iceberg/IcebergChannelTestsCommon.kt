...
/**
 * The end-to-end claim, ported from the reference's IcebergChannelTestsJvm, itself a port of the eclair fork's IcebergChannelSpec: Lightning payments added
 ...
 * funding output.
 */
class IcebergChannelTestsCommon : LightningTestSuite() {
    ...
    fun `how many group operations ONE payment actually costs`() {
        ...
        val group = IcebergSigner.keygen(8, 3, randomBytes32())
